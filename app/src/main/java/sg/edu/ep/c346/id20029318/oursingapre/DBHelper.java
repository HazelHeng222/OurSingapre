...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_SQKM = "areaKM2";
    ...
    public long insertIsland(String name, String description, int areaKM2, int stars) {
        // Get an instance of the database for writing
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_NAME, name);
        values.put(COLUMN_DESCRIPTION, description);
        values.put(COLUMN_SQKM, areaKM2);
    ...
    public ArrayList<Island> getAllIslands() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int areaKM2 = cursor.getInt(3);
                int stars = cursor.getInt(4);

                Island newIsland = new Island(id, name, description, areaKM2, stars);
    ...
    public int updateIsland(Island data){
        ...
        values.put(COLUMN_SQKM, data.getAreaKM2());
